...
export const cityProfiles: CityClimateProfile[] = [
  {
    id: "prayagraj-in",
    name: "Prayagraj",
    state: "Uttar Pradesh",
    ...
    hotspots: [
      {
        ...
        signals: {
          ...
          landUseHeat: 0.74,
          vegetationProximity: 0.28,
          waterProximity: 0.34
        },
        recommendations: createLocalRecommendations({
          roadDensity: 0.82,
          buildingDensity: 0.76,
          landUseHeat: 0.74,
          vegetationProximity: 0.28,
      ...
      {
        id: "kareli",
        name: "Kareli Dense Residential Zone",
        coordinates: { lat: 25.4342, lng: 81.8174 },
        radiusMeters: 1350,
        averageTemperatureC: 39.8,
        riskCategory: "High",
        signals: {
          roadDensity: 0.58,
          buildingDensity: 0.8,
          landUseHeat: 0.62,
          vegetationProximity: 0.24,
          waterProximity: 0.31
        },
        recommendations: createLocalRecommendations({
          roadDensity: 0.58,
        ...
        suggestedAction: "Increase pocket parks, green roofs, and low-water native tree cover."
      }
    ],
    layerSummaries: {
